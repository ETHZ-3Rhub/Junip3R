...
from app.labeller.widgets.image_navigation import ImageNavigation
from app.labeller.widgets.pose_editor import PoseEditor
from app.labeller.widgets.selection_controls import SelectionControls
