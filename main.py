...
from labeller import from_config_file as labeller_from_config_file
from frame_extractor import from_config_file as frame_extractor_from_config_file
...
class AppController(QObject):
    ...
    def _create_window(self, app_id: AppId) -> QMainWindow:
        if app_id == "labeller":
...
def main() -> int:
    ...
    controller = AppController(config_file=config_file)
