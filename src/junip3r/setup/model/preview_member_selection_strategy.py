...
from junip3r.labeller.data.types.abc import IInstance, InstanceID, Selection
from junip3r.labeller.model.member_selection_strategy import MemberSelectionStrategy


class PreviewMemberSelectionStrategy(MemberSelectionStrategy):
    ...
    def auto_advance(self, instances: Sequence[IInstance], selection: Optional[Selection]) -> Optional[Selection]:
        return self.next_member_manual(instances, selection)
