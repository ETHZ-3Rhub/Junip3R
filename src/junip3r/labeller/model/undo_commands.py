from typing import Protocol, Sequence, Optional, cast, Any

from PySide6.QtGui import QUndoCommand

from junip3r.labeller.data.types.abc import IInstance, InstanceID, Selection, IInstanceType, ILabellerObject, Point, \
