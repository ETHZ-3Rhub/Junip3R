...
from junip3r.labeller.data.types.abc import Box, IInstance, IInstanceType, InstanceID, Point, \
    Selection, IInstanceMember
...
class IUndoModel(Protocol):
    ...
    def get_member(self, image_index: int, selection: Selection) -> IInstanceMember | None: ...
